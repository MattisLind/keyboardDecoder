...
public:
    ...
    Keypad(char *userKeymap, byte *row, byte *col, byte numRows, byte numCols, byte shKey, char * shKeymap, byte ctKey, char * ctKeymap);
    ...
    void begin(char *userKeymap, char * shKeymap, char * ctKeymap);
